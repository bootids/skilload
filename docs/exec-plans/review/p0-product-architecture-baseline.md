...
- [x] (2026-08-18 04:39Z) Clarified recovery-qualified workspace atomicity, Git-resolved linked-worktree exclusion, concrete source/discovery ceilings, and absolute XDG handling; the original documentation acceptance gates and focused consistency checks pass. Next: push the preliminary review ledger, reply to each source, resolve its thread, and reconcile the final log.
