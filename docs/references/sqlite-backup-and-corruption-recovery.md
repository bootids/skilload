...
Scope: SQLite online backup, WAL-mode file generations, integrity checks, and salvage behavior relevant to skilload database migration and `database-corruption-v1`, verified against official SQLite documentation on 2026-08-18.
